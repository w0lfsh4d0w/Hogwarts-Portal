...
?>
  ...
  @keyframes magicGlow {
    ...
    50% { opacity: 1; transform: scale(1.15); filter: brightness(1.2) drop-shadow(0 0 8px rgba(255, 215, 0, 0.6)); }
  }

  @keyframes dashboardFloat {
    0% { transform: translateY(0px) rotate(0deg) scale(1); opacity: 0; filter: blur(0px); }
    10% { opacity: 1; filter: blur(0px); }
    50% { filter: blur(1px); }
    90% { opacity: 1; filter: blur(0px); }
    100% { transform: translateY(-120px) rotate(360deg) scale(0.8); opacity: 0; filter: blur(2px); }
  }
...
?>
  ...
  @keyframes enhancedShimmer {
    0% { background-position: -200% 0; filter: brightness(1) saturate(1); }
    25% { filter: brightness(1.2) saturate(1.3); }
    50% { filter: brightness(1.4) saturate(1.5); }
    75% { filter: brightness(1.2) saturate(1.3); }
    100% { background-position: 200% 0; filter: brightness(1) saturate(1); }
  }

  @keyframes magicPulse {
    0%, 100% { opacity: 0; transform: translate(-50%, -50%) scale(0.8); filter: blur(1px); }
    50% { opacity: 0.8; transform: translate(-50%, -50%) scale(1.3); filter: blur(0px) drop-shadow(0 0 10px rgba(255, 215, 0, 0.6)); }
  }

  @keyframes float {
    0% { transform: translateY(0px) rotate(0deg); opacity: 0; filter: blur(1px); }
    10% { opacity: 1; filter: blur(0px); }
    50% { transform: translateY(-50px) rotate(180deg) scale(1.2); filter: blur(0.5px); }
    90% { opacity: 1; filter: blur(0px); }
    100% { transform: translateY(-100px) rotate(360deg) scale(0.8); opacity: 0; filter: blur(2px); }
  }

  @keyframes enhancedFloat {
    0% { transform: translateY(0px) rotate(0deg) scale(1); opacity: 0; filter: blur(2px) brightness(0.5); }
    5% { opacity: 0.3; filter: blur(1px) brightness(0.7); }
    10% { opacity: 1; filter: blur(0px) brightness(1); }
    25% { transform: translateY(-25px) rotate(90deg) scale(1.1); filter: brightness(1.2); }
    50% { transform: translateY(-50px) rotate(180deg) scale(1.3); filter: brightness(1.5) drop-shadow(0 0 8px rgba(255, 215, 0, 0.8)); }
    75% { transform: translateY(-75px) rotate(270deg) scale(1.1); filter: brightness(1.2); }
    90% { opacity: 1; filter: blur(0px) brightness(1); }
    95% { opacity: 0.3; filter: blur(1px) brightness(0.7); }
    100% { transform: translateY(-100px) rotate(360deg) scale(0.8); opacity: 0; filter: blur(2px) brightness(0.5); }
  }
